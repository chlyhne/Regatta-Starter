  ...
  const venues = [
    {
      ...
      name: "Harbor",
      marks: [
        { id: "mark-a", name: "A", description: "Alpha", lat: 55.05, lon: 12.05, role: "none" },
        { id: "mark-b", name: "B", description: "Bravo", lat: 55.06, lon: 12.06, role: "none" },
        { id: "mark-gate", name: "Gate", description: "Gate mark", lat: 55.07, lon: 12.07, role: "none" },
      ],
      defaultRoute: [],
      updatedAt: Date.now(),
    },
