const els = {
  ...
  openCourseMap: document.getElementById("open-course-map"),
  openCourseMarks: document.getElementById("open-course-marks"),
  openSavedMarks: document.getElementById("open-saved-marks"),
  openCourseKeyboard: document.getElementById("open-course-keyboard"),
  courseToggle: document.getElementById("course-toggle"),
  clearCourse: document.getElementById("clear-course"),
  courseMarks: document.getElementById("course-marks"),
  finishStatus: document.getElementById("finish-status"),
  finishUseStart: document.getElementById("finish-use-start"),
  openFinishMap: document.getElementById("open-finish-map"),
  swapFinish: document.getElementById("swap-finish"),
  loadCourse: document.getElementById("load-course"),
  saveCourse: document.getElementById("save-course"),
  ...
  loadCourseModal: document.getElementById("load-course-modal"),
  savedCoursesList: document.getElementById("saved-courses-list"),
  confirmCourseLoad: document.getElementById("confirm-course-load"),
  confirmCourseDelete: document.getElementById("confirm-course-delete"),
  closeCourseLoad: document.getElementById("close-course-load"),
  savedMarksModal: document.getElementById("saved-marks-modal"),
  savedMarksList: document.getElementById("saved-marks-list"),
  confirmMarkAdd: document.getElementById("confirm-mark-add"),
  confirmMarkDelete: document.getElementById("confirm-mark-delete"),
  closeMarks: document.getElementById("close-marks"),
