...
\subsection{RaceKBL windowing and cache behavior}

This subsection summarizes the client-side performance tricks used in the RaceKBL view so
large history windows remain responsive on mobile hardware.

The RaceKBL client retains only a bounded horizon locally (currently eight hours) even
